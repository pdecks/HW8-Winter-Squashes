...
class Squash(Melon):
    ...
    # Works, but not necessary, as Squash already inherits
    # the same methods from Melon
    # def __init__(self, melon_type):
    #     return super(Squash, self).__init__(melon_type)
    # def __str__(self):
    #     return super(Squash, self).__str__()

    def prep(self):
        """Paint the squash to pass the InspectorBot"""
